...
namespace CmsShoppingCart.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        //GET  /admin/pages/details/id(some-Id lik 5)
        ...
        //GET  /admin/pages/Create new page
        ...
        //GET  /admin/pages/edit/id(some-Id lik 5)
        ...
        //GET  /admin/pages/delete/id(some-Id lik 5)
        public async Task<IActionResult> Delete(int id)
        {
            Page page = await context.Pages.FindAsync(id);
            if (page == null)
            {
                TempData["Error"] = "The page dose not exit!";
            }
            else
            { 
            context.Remove(page);
